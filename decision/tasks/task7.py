...
from decision.prompt.task7 import formatted_prompt
...
prompt_file = os.path.join(task_path, "prompt", "task7.py")
log_dir = os.path.join(base_path, "outputs", "decision", "log", "log_7")
mem_dir = os.path.join(base_path, "outputs", "decision", "memory", "mem_7")
