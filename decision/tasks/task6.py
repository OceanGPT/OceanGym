...
from decision.prompt.task6 import formatted_prompt
...
prompt_file = os.path.join(task_path, "prompt", "task6.py")
log_dir = os.path.join(base_path, "outputs", "decision", "log", "log_6")
mem_dir = os.path.join(base_path, "outputs", "decision", "memory", "mem_6")
