...
from decision.prompt.task1 import formatted_prompt
...
prompt_file = os.path.join(task_path, "prompt", "task1.py")
log_dir = os.path.join(base_path, "outputs", "decision", "log", "log_1")
mem_dir = os.path.join(base_path, "outputs", "decision", "memory", "mem_1")
