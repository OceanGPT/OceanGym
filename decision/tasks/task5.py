...
from decision.prompt.task5 import formatted_prompt
...
prompt_file = os.path.join(task_path, "prompt", "task5.py")
log_dir = os.path.join(base_path, "outputs", "decision", "log", "log_5")
mem_dir = os.path.join(base_path, "outputs", "decision", "memory", "mem_5")
