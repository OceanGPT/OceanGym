...
from decision.prompt.task3 import formatted_prompt
...
prompt_file = os.path.join(task_path, "prompt", "task3.py")
log_dir = os.path.join(base_path, "outputs", "decision", "log", "log_3")
mem_dir = os.path.join(base_path, "outputs", "decision", "memory", "mem_3")
