...
from decision.prompt.task2 import formatted_prompt
...
log_dir = os.path.join(base_path, "outputs", "decision", "log", "log_2")
mem_dir = os.path.join(base_path, "outputs", "decision", "memory", "mem_2")
