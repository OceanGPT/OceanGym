...
target_item_image_path = os.path.join(task_path, "pic", "task4.png")
...
variables = {
    "target_item": "Sunken Ship",
    "target_item_image": base64_image_data,
    "target_item_description": "An ancient sunken ship, likely located near a cliff edge",
    "task_description": "Find the sunken ship and report its exact location to the user",
