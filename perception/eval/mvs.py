"""
'mvs' means 'multi-view with sonar'
"""
    ...
    messages.append(
        {
            ...
            "content": [
                {
                    "type": "input_image",
                    "image_url": f"data:image/png;base64,{img_b64_sonar}"
                },
                {
                    "type": "input_text",
                    "text": prompt_sonar
    ...
    messages.append(
        {
            ...
            "content": [
                {
                    "type": "image",
                    "image_url": f"data:image;base64,{img_b64_sonar}"
                },
                {
                    "type": "text",
                    "text": prompt_sonar
...
def call_BMB(
    ...
    messages = []
    messages.append(
        {'role': 'user', 'content': [image_sonar, prompt_sonar, image, prompt]}
    )
...
# Old Prompt
#     PROMPT00 = f"""You are an assistant that analyzes an image and checks which of the following options appear in it. Before that, I have already provide you a sonar image to help you choose the correct one.
...
# """
    ...
    p.add_argument('--exp_name', type=str, default="Result_MVwS_highLight_00")
    ...
    p.add_argument('--options', nargs='+', default=OPTS,) # e.g. python xxx.py --directions Front Down Back
    # model parameters
